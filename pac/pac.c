...
MODULE_VERSION("1.4");
MODULE_DESCRIPTION("Kernel module of Proactive ACK Control (PAC) - Client mode bypass");
...
int init_module(void)
{
	...
	printk(KERN_INFO "PAC: Module loaded (v1.4 - client bypass)\n");
	return 0;
}
